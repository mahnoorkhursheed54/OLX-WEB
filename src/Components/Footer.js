...
function Footer(){
    return(
        ...
        <div className="footerb flex">
            <h2 className="first cfff font s14">Other Countries India - South Africa - Indonesia</h2>
            <h2 className="second cfff font s14">Free Classifieds in Pakistan. © 2006-2020 OLX</h2>
        </div>
        </React.Fragment>
    )
}
